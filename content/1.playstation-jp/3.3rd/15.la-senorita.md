...
|SINGLE| :badge[BASIC]{type="warning"} | :lv{type="warning" :links='["/playstation-jp/3rd","/gameboy/1st"]' :lv='[4,"?"]'}  :lv{type="warning" :links='["/windows/grand-prix"]' :lv='[6]'} |241/0||
|SINGLE| :badge[DIFFICULT]{type="danger"} | :lv{type="danger" :links='["/playstation-jp/3rd","/gameboy/1st"]' :lv='[6,"?"]'}  :lv{type="danger" :links='["/windows/grand-prix"]' :lv='[8]'} |255/0||
|SINGLE| :badge[EXPERT]{type="success"} | :lv{type="success" :links='["/playstation-jp/3rd","/gameboy/1st"]' :lv='[7,"?"]'}  :lv{type="success" :links='["/windows/grand-prix"]' :lv='[10]'} |294/0||
