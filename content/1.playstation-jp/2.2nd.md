...
|----|------|---|------|------|------|-----------|
|[20, november -DDR VERSION-](/playstation-jp/2nd/20-november-ddr)|N.M.R. feat. dj nagureo|130| :chart{:types="chartTypes" :levels='[1,3,4]'} | :chart{:types="chartTypes" :levels='[2,4]'} | :chart{:types="chartTypes" :levels='[1,3,4]'} | :chart{:types="chartTypes" :levels='[9,9,9]'} |
...
|[IN THE NAVY '99](/playstation-jp/2nd/in-the-navy)|CAPTAIN JACK|135| :chart{:types="chartTypes" :levels='[4]' :charts='[4]'} | :chart{:types="chartTypes" :levels='[4]' :charts='[4]'} |||
|[KEEP ON MOVIN'](/playstation-jp/2nd/keep-on-movin)|N.M.R.|132| :chart{:types="chartTypes" :levels='[3,4,5]'} | :chart{:types="chartTypes" :levels='[3,4]'} | :chart{:types="chartTypes" :levels='[3,4,5]'} | :chart{:types="chartTypes" :levels='[9,9,9]'} |
|[LET THEM MOVE](/playstation-jp/2nd/let-them-move)|N.M.R.|115| :chart{:types="chartTypes" :levels='[1,2,4]'} | :chart{:types="chartTypes" :levels='[2,3]'} | :chart{:types="chartTypes" :levels='[1,2,4]'} | :chart{:types="chartTypes" :levels='[9,9,9]'} |
