...
|----|------|---|------|------|------|
|[~~HAVE YOU NEVER BEEN MELLOW~~](/playstation-jp/1st/have-you-never-been-mellow)|THE OLIVIA PROJECT|126| :chart{:colors="colors" :levels='[1,2]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[2]' :charts='[1]'} | :chart{:colors="colors" :levels='[1,2]' :charts='[1,2]'} |
|[KUNG FU FIGHTING](/playstation-jp/1st/kung-fu-fighting)|BUS STOP featuring CARL DOUGLAS|116| :chart{:colors="colors" :levels='[2,3,3]'} | :chart{:colors="colors" :levels='[3]' :charts='[1]'} | :chart{:colors="colors" :levels='[2,3,3]'} |
|[THAT'S THE WAY (I LIKE IT)](/playstation-jp/1st/thats-the-way)|KC & THE SUNSHINE BAND|110| :chart{:colors="colors" :levels='[2,3]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[3]' :charts='[1]'} | :chart{:colors="colors" :levels='[2,3]' :charts='[1,2]'} |
|[butterfly](/playstation-jp/1st/butterfly)|smile. dk|135| :chart{:colors="colors" :levels='[3,3,4]'} | :chart{:colors="colors" :levels='[4]' :charts='[1]'} | :chart{:colors="colors" :levels='[3,3,4]'} |
|[~~MY FIRE~~](/playstation-jp/1st/my-fire)|X-TREME|130| :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[5]' :charts='[1]'} | :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} |
|[~~LET'S GET DOWN~~](/playstation-jp/1st/lets-get-down)|JT PLAYAZ|128| :chart{:colors="colors" :levels='[3,4]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[4]' :charts='[1]'} | :chart{:colors="colors" :levels='[3,4]' :charts='[1,2]'} |
|[LITTLE BITCH](/playstation-jp/1st/little-bitch)|THE SPECIALS|160| :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[5]' :charts='[1]'} | :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} |
|[~~STRICTRY BUSINESS~~](/playstation-jp/1st/strictry-business)|MANTRONIK vs EPMD|125| :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[5]' :charts='[1]'} | :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} |
|[PARANOiA](/playstation-jp/1st/paranoia)|180|180| :chart{:colors="colors" :levels='[6,7]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[7]' :charts='[1]'} | :chart{:colors="colors" :levels='[6,7]' :charts='[1,2]'} |
...
|[KEEP ON MOVIN'](/playstation-jp/2nd/keep-on-movin)|N.M.R.|132|||| :chart{:colors="colors" :levels='[9,9,9]' :charts='[1,2,3]'} |
|[LET THEM MOVE](/playstation-jp/2nd/let-them-move)|N.M.R.|115|||| :chart{:colors="colors" :levels='[9,9,9]' :charts='[1,2,3]'} |
|[~~20, NOVEMBER -D.D.R. version-~~](/playstation-jp/2nd/20-november-ddr)|N.M.R. feat. dj nagureo|130|||| :chart{:colors="colors" :levels='[9,9,9]' :charts='[1,2,3]'} |
...
|[PUT YOUR FAITH IN ME (Jazzy Groov)](/playstation-jp/2nd/put-your-faith-in-me-jazzy-groove)|UZI-LAY|119| :chart{:colors="colors" :levels='[4,5,6]' :charts='[1,2,3]'} | :chart{:colors="colors" :levels='[5,6]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[4,5,6]' :charts='[1,2,3]'} ||
...
|[BRILLIANT 2U (Orchestra-Groov)](/playstation-jp/2nd/brilliant-2u-orchestra-groove)|NAOKI|150| :chart{:colors="colors" :levels='[5,6,7]' :charts='[1,2,3]'} | :chart{:colors="colors" :levels='[4,5]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[5,6,7]' :charts='[1,2,3]'} ||
...
|[PARANOiA MAX in roulette](/playstation-jp/1st/paranoia-max)|190|190| :chart{:colors="colors" :levels='[6,8,8]' :charts='[1,2,3]'} | :chart{:colors="colors" :levels='[7,8]' :charts='[1,2]'} | :chart{:colors="colors" :levels='[6,8,8]' :charts='[1,2,3]'} ||
