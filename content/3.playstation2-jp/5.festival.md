...
|----|------|---|------|------|
|[キューティーハニー](/playstation2-jp/festival/cuty-honey)|(アニメ)|156| :chart{:types="chartTypes" :levels='[1,4,6,8]'} | :chart{:types="chartTypes" :levels='[3,5,7]' :charts='[1,2,3]'} |
|[Diamonds](/playstation2-jp/festival/diamonds)|(J-POP)|111| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,7]' :charts='[1,2,3]'} |
|[学園天国](/playstation2-jp/festival/gakuen-tengoku)|(J-POP)|175| :chart{:types="chartTypes" :levels='[1,5,6,6]'} | :chart{:types="chartTypes" :levels='[4,7,7]' :charts='[1,2,3]'} |
|[おどるポンポコリン](/playstation2-jp/festival/odoru-ponpokorin)|(アニメ)|140| :chart{:types="chartTypes" :levels='[1,2,5,6]'} | :chart{:types="chartTypes" :levels='[4,6,7]' :charts='[1,2,3]'} |
|[Believe](/playstation2-jp/festival/believe)|Eddie.J|136| :chart{:types="chartTypes" :levels='[1,4,6,7]'} | :chart{:types="chartTypes" :levels='[4,7,8]' :charts='[1,2,3]'} |
|[BIZARRE LOVE TRIANGLE](/playstation2-jp/festival/bizarre-love-triangle)|Jerry|119| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,7,7]' :charts='[1,2,3]'} |
|[Kids in America](/playstation2-jp/festival/kids-in-america)|KIM WILDE|159| :chart{:types="chartTypes" :levels='[1,4,6,7]'} | :chart{:types="chartTypes" :levels='[3,7,8]' :charts='[1,2,3]'} |
|[LADIES' NIGHT](/playstation2-jp/festival/ladies-night)|∠R|120| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,8]' :charts='[1,2,3]'} |
|[Like A Virgin](/playstation2-jp/festival/like-a-virgin)|tama_happytone|126| :chart{:types="chartTypes" :levels='[1,3,5,8]'} | :chart{:types="chartTypes" :levels='[3,5,8]' :charts='[1,2,3]'} |
|[Superstar](/playstation2-jp/festival/superstar)|Jamelia|110| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,7]' :charts='[1,2,3]'} |
|[WAITING FOR TONIGHT](/playstation2-jp/festival/waiting-for-tonight)|P.A.T|125| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,8]' :charts='[1,2,3]'} |
|[.59](/playstation-jp/4th/tengoku)|dj TAKA|123-135| :chart{:types="chartTypes" :levels='[1,4,6,7]'} | :chart{:types="chartTypes" :levels='[4,6,7]' :charts='[1,2,3]'} |
...
|[Abyss](/playstation-jp/5th/abyss)|dj TAKA|142| :chart{:types="chartTypes" :levels='[1,2,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]' :charts='[1,2,3]'} |
|[BROKEN MY HEART](/playstation-jp/extra/broken-my-heart)|NAOKI feat.PAULA TERRY|160| :chart{:types="chartTypes" :levels='[1,4,5,9]'} | :chart{:types="chartTypes" :levels='[4,6,9]' :charts='[1,2,3]'} |
|[CANDY♥](/playstation2-jp/max2/candy-heart)|小坂りゆ|180| :chart{:types="chartTypes" :levels='[2,3,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]' :charts='[1,2,3]'} |
|[D2R](/playstation2-jp/max2/d2r)|NAOKI|160| :chart{:types="chartTypes" :levels='[1,3,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]' :charts='[1,2,3]'} |
|[DIVE](/playstation-jp/extra/dive)|Be For U|155| :chart{:types="chartTypes" :levels='[1,4,5,8]'} | :chart{:types="chartTypes" :levels='[4,6,7]' :charts='[1,2,3]'} |
|[Don't Stop! (AMD 2nd MIX)](/playstation-jp/4th/dont-stop)|Dr. VIBE feat. JP Miles|130| :chart{:types="chartTypes" :levels='[1,4,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,6]' :charts='[1,2,3]'} |
|[Electro Tuned (the SubS mix)](/playstation-jp/5th/electro-tuned)|TaQ|125| :chart{:types="chartTypes" :levels='[1,5,6,9]'} | :chart{:types="chartTypes" :levels='[4,6,8]' :charts='[1,2,3]'} |
|[era (nostalmix)](/playstation-jp/4th/era)|TaQ|90-180| :chart{:types="chartTypes" :levels='[2,3,6,8]'} | :chart{:types="chartTypes" :levels='[4,6,8]' :charts='[1,2,3]'} |
|[Firefly](/playstation2-jp/max/firefly)|BeForU|150| :chart{:types="chartTypes" :levels='[1,1,5,7]'} | :chart{:types="chartTypes" :levels='[2,5,8]' :charts='[1,2,3]'} |
|[Funk Boogie](/playstation2-jp/festival/funk-boogie)|Funk Kid feat. KOOL BOYS|127| :chart{:types="chartTypes" :levels='[1,4,5,6]'} | :chart{:types="chartTypes" :levels='[3,5,6]' :charts='[1,2,3]'} |
|[GRADIUSIC CYBER (AMD G5 MIX)](/playstation-jp/3rd/gradiusic-cyber-amd)|BIG-O feat. TAKA|160| :chart{:types="chartTypes" :levels='[1,5,7,8]'} | :chart{:types="chartTypes" :levels='[5,8,9]' :charts='[1,2,3]'} |
|[Holic](/playstation-jp/4th/holic)|TaQ|155| :chart{:types="chartTypes" :levels='[1,4,6,8]'} | :chart{:types="chartTypes" :levels='[4,6,8]' :charts='[1,2,3]'} |
...
|[MATSURI (J-SUMMER MIX)](/playstation2-jp/festival/matsuri-j-summer)|RE-VENGE|180| :chart{:types="chartTypes" :levels='[4,5,9]' :charts='[1,2,3]'} | :chart{:types="chartTypes" :levels='[4,6,8]' :charts='[1,2,3]'} |
