...
|----|------|---|------|------|
|[BABY LOVE ME](/playstation2-jp/max2/baby-love-me)|JUDY CRYSTAL|160| :chart{:types="chartTypes" :levels='[3,5,8]'} | :chart{:types="chartTypes" :levels='[3,5,8]'} |
|[BRE∀K DOWN!](/playstation2-jp/max2/break-down)|Be For U|190| :chart{:types="chartTypes" :levels='[4,6,9]'} | :chart{:types="chartTypes" :levels='[4,6,9]'} |
|[Burning Heat! (3 Option Mix)](/playstation2-jp/max2/burning-heat)|Mr. T with Motoaki F.|166| :chart{:types="chartTypes" :levels='[2,5,9]'} | :chart{:types="chartTypes" :levels='[2,6,9]'} |
|[CANDY♥](/playstation2-jp/max2/candy-heart)|小坂りゆ|180| :chart{:types="chartTypes" :levels='[3,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]'} |
|[D2R](/playstation2-jp/max2/d2r)|NAOKI|160| :chart{:types="chartTypes" :levels='[3,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]'} |
|[DESTINY](/playstation2-jp/max2/destiny)|NAOKI feat. PAULA TERRY|155| :chart{:types="chartTypes" :levels='[2,5,7]'} | :chart{:types="chartTypes" :levels='[2,6,8]'} |
|[DIVE TO THE NIGHT](/playstation2-jp/max2/dive-to-the-night)|小坂りゆ|155| :chart{:types="chartTypes" :levels='[3,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,7]'} |
|[DRIFTING AWAY](/playstation2-jp/max2/drifting-away)|LANGE feat. SKYE|136| :chart{:types="chartTypes" :levels='[2,5,8]'} | :chart{:types="chartTypes" :levels='[2,5,8]'} |
|[ever snow](/playstation2-jp/max2/ever-snow)|YOMA KOMATSU|145| :chart{:types="chartTypes" :levels='[2,5,8]'} | :chart{:types="chartTypes" :levels='[2,6,8]'} |
|[FANTASY](/playstation2-jp/max2/fantasy)|LOCKOUT|140| :chart{:types="chartTypes" :levels='[2,5,6]'} | :chart{:types="chartTypes" :levels='[2,5,7]'} |
|[i feel...](/playstation2-jp/max2/i-feel)|AKIRA YAMAOKA|141| :chart{:types="chartTypes" :levels='[3,6,9]'} | :chart{:types="chartTypes" :levels='[2,5,9]'} |
|[LITTLE BOY (BOY ON BOY MIX)](/playstation2-jp/max2/little-boy)|CAPTAIN JACK|150| :chart{:types="chartTypes" :levels='[3,6,8]'} | :chart{:types="chartTypes" :levels='[3,6,9]'} |
|[LIVING IN AMERICA](/playstation2-jp/max2/living-in-america)|ROSE & JOHN|169| :chart{:types="chartTypes" :levels='[3,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,8]'} |
|[LONG TRAIN RUNNIN'](/playstation2-jp/max2/long-train-runnin)|BUS STOP|126| :chart{:types="chartTypes" :levels='[2,5,7]'} | :chart{:types="chartTypes" :levels='[3,5,7]'} |
|[LOOK AT US (Daddy DJ Remix)](/playstation2-jp/max2/look-at-us)|SARINA PARIS|135| :chart{:types="chartTypes" :levels='[2,6,7]'} | :chart{:types="chartTypes" :levels='[2,5,7]'} |
|[MAXIMUM OVERDRIVE (KC Club Mix)](/playstation2-jp/max2/maximum-overdrive)|2 UNLIMITED|140| :chart{:types="chartTypes" :levels='[2,4,8]'} | :chart{:types="chartTypes" :levels='[1,5,8]'} |
|[NOTHING GONNA STOP (Dance Mania Mix)](/playstation2-jp/max2/nothing-gonna-stop)|MICKY|145| :chart{:types="chartTypes" :levels='[2,5,7]'} | :chart{:types="chartTypes" :levels='[2,6,7]'} |
|[rain of sorrow](/playstation2-jp/max2/rain-of-sorrow)|NM feat. Ebony Fay|140| :chart{:types="chartTypes" :levels='[2,5,9]'} | :chart{:types="chartTypes" :levels='[2,5,8]'} |
|[Secret Rendez-vous](/playstation2-jp/max2/secret-rendez-vous)|DIVAS|98| :chart{:types="chartTypes" :levels='[2,5,7]'} | :chart{:types="chartTypes" :levels='[2,5,7]'} |
|[SO FABULOUS SO FIERCE (FREAK OUT)](/playstation2-jp/max2/so-fabulous-so-fierce)|THUNDERPUSS feat. JOCELYN ENRIQUEZ|128| :chart{:types="chartTypes" :levels='[3,5,7]'} | :chart{:types="chartTypes" :levels='[3,6,8]'} |
|[Spin the disc](/playstation2-jp/max2/spin-the-disc)|good-cool|130| :chart{:types="chartTypes" :levels='[2,5,8]'} | :chart{:types="chartTypes" :levels='[2,5,8]'} |
|[STAY](/playstation2-jp/max2/stay)|TESS|140| :chart{:types="chartTypes" :levels='[2,5,9]'} | :chart{:types="chartTypes" :levels='[2,5,9]'} |
|[Sweet Sweet ♥ Magic](/playstation2-jp/max2/sweet-sweet-love-magic)|jun|180| :chart{:types="chartTypes" :levels='[3,6,9]'} | :chart{:types="chartTypes" :levels='[3,6,9]'} |
|[THE REFLEX](/playstation2-jp/max2/the-reflex)|DURAN DURAN|126| :chart{:types="chartTypes" :levels='[2,5,8]'} | :chart{:types="chartTypes" :levels='[2,5,7]'} |
|[THE WHISTLE SONG (Blow My Whistle Bitch)](/playstation2-jp/max2/the-whistle-song)|DJ ALIGATOR PROJECT|140| :chart{:types="chartTypes" :levels='[3,4,7]'} | :chart{:types="chartTypes" :levels='[3,4,7]'} |
...
|[AM-3P (303 BASS MIX)](/playstation2-jp/max2/am-3p-303-bass)|KTz (remixed by U1)|130| :chart{:types="chartTypes" :levels='[3,6,7]'} | :chart{:types="chartTypes" :levels='[5,6,7]'} |
