...
#default
  ...
  ::card{icon=simple-icons:playstation2}
  #title
  [DanceDanceRevolution X](/playstation2-us/x)
  #description
  X-perience the X-treme <time>2008-09-16</time>
  ::
  ::card{icon=simple-icons:wii}
  #title
  [Dance Dance Revolution HOTTEST PARTY](/wii-us/hottest)
  #description
  YOU'RE INVITED TO THE HOTTEST PARTY! <time>2007-09-25</time>
  ::
  ::card{icon=simple-icons:playstation2}
  #title
  [DDRMAX Dance Dance Revolution](/playstation2-us/max)
  #description
  REVOLUTIONARY TO THE MAX! <time>2002-10-29</time>
  ::
::
